...
alias pipInstall="curl https://bootstrap.pypa.io/get-pip.py | python2"
alias pip3Install="curl https://bootstrap.pypa.io/get-pip.py | python3"
...
alias ytdlUpdate="pip3 install -U youtube-dl"
