...
alias columns='\column -t -c $COLUMNS'
...
alias web2pdf='wkhtmltopdf --outline --header-line --footer-line --header-left [webpage] --footer-left "[isodate] [time]" --footer-right [page]/[toPage]'
