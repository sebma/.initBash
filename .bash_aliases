...
alias toupper="\perl -pe 'tr/a-z/A-Z/'"
...
alias wanIPv6="time \dig @resolver1.opendns.com AAAA myip.opendns.com +short -6 2>/dev/null || time host -6 -t AAAA myip.opendns.com resolver1.opendns.com | awk '/\<has\>/{print\$NF}'"
