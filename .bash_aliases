...
#alias ftp="\pftp" # Passive FTP # Removed from Ubuntu cf. https://launchpad.net/ubuntu/+source/pftp
alias .....="cd ../../../.."
alias ....="cd ../../.."
alias ...="cd ../.."
alias ..="cd .."
...
alias 2iec='\numfmt --suffix=B --format=%.5f --to=iec-i'
...
alias 2si='\numfmt  --suffix=B --format=%.5f --to=si'
alias 2upper=toupper
alias Cut='\cut -c 1-$COLUMNS'
alias Pgrepfirst="grepfirst -P"
...
alias archi="arch 2>/dev/null || uname -m"
alias ascii2str='\xxd -r -p <<<'
...
alias digsimple="dig +noall +answer +multiline"
alias digsimple2="dig +search +noquestion +nostats +noedns +nocomments +nocmd +multiline"
...
alias findBigFiles="findBiggerThan +100MiB | sort -rhk5"
...
alias geoipCity="geoipjson2 '.city+\" \"+.country' -r"
...
alias gpgKeyringFileInfo='\gpg --show-keys --keyid-format=long'
...
alias jpeg2pdfletter="jpeg2pdf -units pixelsperinch -page letter"
alias jpeg2pdfletterR="jpeg2pdf -units pixelsperinch -page 792x612"
...
alias no='yes n'
alias nocomment='\egrep -v "^\s*(#|$|;\s|//\s|;;\s)"'
alias od="\od -ct x1z"
...
alias ports="lsof -nPi | grep LISTEN"
...
alias tolowerAwk="awk '{print tolower(\$0)}'"
alias tolowerPerl="\perl -pe 'tr/A-Z/a-z/'"
alias tolowerSed="sed 's/.*/\L&/'"
alias tolowerTr='tr [:upper:] [:lower:]'
...
alias videoTo1.5Mbps="videoToAnyBitrate 1.5M"
alias videoTo1Mbps="videoToAnyBitrate 1M"
alias videoTo2Mbps="videoToAnyBitrate 2M"
alias videoTo500kbps="videoToAnyBitrate 500k"
alias videoTo750kbps="videoToAnyBitrate 750k"
alias view='vim -R'
