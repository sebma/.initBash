...
alias openwrtMostSupportedRouters="curl -s https://openwrt.org/_media/toh_dump_tab_separated_csv.csv.gz | gunzip -c  | awk '/WiFi Router/{print\$4}' | sort | uniq -c | sort -rn"
alias page="\head -50"
