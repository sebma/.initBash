...
alias ...="cd ../.."
alias ..="cd .."
alias 2iec='\numfmt --to=iec-i --suffix=B --format=%.5f'
alias 2si='\numfmt  --to=si    --suffix=B --format=%.5f'
...
alias jpeg2pdfA4R="jpeg2pdf -units pixelsperinch -page A4^T"
alias jpeg2pdfletter="jpeg2pdf -units pixelsperinch -page letter"
alias jpeg2pdfletterR="jpeg2pdf -units pixelsperinch -page letter^T"
